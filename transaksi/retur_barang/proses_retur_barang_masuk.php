...
if("ok"){
	$query_retur="INSERT INTO retur_barang VALUES('$id_trx','$id_masuk','$id_user','$tgl','Retur Barang Masuk')";
	...
	alert('Retur Barang berhasil diproses..'); window.location='../../retur_masuk.php'; </script> ";
}
else{
	echo "<script type='text/javascript'> 
	alert('Gagal memproses Retur!!!..'); window.location='../../retur_masuk.php'; </script> ";
}
?>